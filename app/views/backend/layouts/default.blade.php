				...
				<div class="navbar-inner">
					<div class="container">
						...
						<div class="nav-collapse collapse">
							<ul class="nav">
							<li{{ (Request::is('/') ? ' class="active"' : '') }}><a href="{{ URL::to('/') }}"><i class="icon-home icon-white"></i> Budget</a></li>
								<li{{ (Request::is('accounts') ? ' class="active"' : '') }}><a href="{{ URL::to('accounts') }}"><i class="icon-list icon-white"></i> Accounts</a></li>
							</ul>
